...
LANGUAGES = {
    "fa": {
        ...
        "help_app_intro_text": "برنامه ANIGMA MODERN PRO یک ابزار پیشرفته برای رمزگذاری و امنیت اطلاعات است. این نرم‌افزار از الگوریتم استاندارد رمزنگاری پیشرفته AES با طول کلید ۲۵۶ بیت در حالت GCM استفاده می‌کند. این سیستم امنیت بسیار بالایی را برای متون و فایل‌های شما فراهم کرده و از دستکاری داده‌ها جلوگیری می‌نماید. همچنین در بخش فایل‌ها، عملیات فشرده‌سازی Zlib جهت کاهش حجم اجرا می‌شود.",
    ...
    "en": {
        ...
        "help_app_intro_text": "ANIGMA MODERN PRO is an advanced cryptographic tool designed for data security. It utilizes the industry-standard AES-256-GCM encryption algorithm. This ensures military-grade encryption and authenticity verification for both text and file payloads. Files are additionally compressed using Zlib before encryption.",
